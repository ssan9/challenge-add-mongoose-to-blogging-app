...
app.get('/blogposts', (req, res) => {
	BlogPosts
		.find()
		// we're limiting because blogposts db has many
...
app.put('/blogposts/:id', (req, res) => {
	...
	if(!(req.params.id && req.body.id && req.params.id === req.body.id)) {
		const message = (
			`Request path id (${re.params.id}) and request body id` +
	...
	// if the user sent over any of te undateableFields, we update those values
	// in document
	const toUpdate = {};
